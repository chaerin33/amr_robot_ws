...
#ifndef ARM_INTERFACES__SRV__DETAIL__GET_TARGET_POSE__FUNCTIONS_H_
#define ARM_INTERFACES__SRV__DETAIL__GET_TARGET_POSE__FUNCTIONS_H_
 ...
 * calls
 * arm_interfaces__srv__GetTargetPose_Request__init().
...
/**
 * It calls
 * arm_interfaces__srv__GetTargetPose_Request__fini()
 ...
 * arm_interfaces__srv__GetTargetPose_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * arm_interfaces__srv__GetTargetPose_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * arm_interfaces__srv__GetTargetPose_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_arm_interfaces
...
/**
 * It calls
 * arm_interfaces__srv__GetTargetPose_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_arm_interfaces
...
/**
 * It allocates the memory for the array and calls
 * arm_interfaces__srv__GetTargetPose_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_arm_interfaces
...
/**
 * It calls
 * arm_interfaces__srv__GetTargetPose_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ARM_INTERFACES__SRV__DETAIL__GET_TARGET_POSE__FUNCTIONS_H_
