...
#include "arm_interfaces/srv/detail/arm_command__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  // Member: object_ids
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.object_ids[0]);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = arm_interfaces::srv::ArmCommand_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const arm_interfaces::srv::ArmCommand_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<arm_interfaces::srv::ArmCommand_Request *>(
    untyped_ros_message);
...
{
  return &arm_interfaces::srv::typesupport_fastrtps_cpp::_ArmCommand_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  // Member: slots
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.slots[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: object_ids
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = arm_interfaces::srv::ArmCommand_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const arm_interfaces::srv::ArmCommand_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<arm_interfaces::srv::ArmCommand_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &arm_interfaces::srv::typesupport_fastrtps_cpp::_ArmCommand_Response__handle;
}
...
{
  return &arm_interfaces::srv::typesupport_fastrtps_cpp::_ArmCommand__handle;
}
